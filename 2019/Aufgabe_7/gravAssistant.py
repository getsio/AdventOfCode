f = open("C:/Ausbildung/Python/AdventOfCode/2019/Aufgabe_7/example.txt", "r")
#f = open("C:/Ausbildung/Python/AdventOfCode/2019/Aufgabe_7/example2.txt", "r")
#f = open("C:/Ausbildung/Python/AdventOfCode/2019/Aufgabe_7/example3.txt", "r")
#f = open("C:/Ausbildung/Python/AdventOfCode/2019/Aufgabe_7/input_data.txt", "r")
